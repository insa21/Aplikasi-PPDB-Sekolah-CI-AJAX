...
class m_artikel extends CI_Model
{
    ...
    var $table = 'artikel';   //table
    var $column_order = array('title ', ' kategori ', ' keyword ', ' date ', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('title', 'kategori'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
