...
class m_artikel_kategori extends CI_Model
{
    ...
    var $table = 'kategori';   //table
    var $column_order = array('id', 'kategori', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('id', 'kategori'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
