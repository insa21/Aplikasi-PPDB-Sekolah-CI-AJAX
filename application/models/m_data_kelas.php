...
class m_data_kelas extends CI_Model
{
    ...
    var $column_order = array('nama', 'kelas', 'jurusan', 'ke', 'status', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama', 'kelas', 'jurusan', 'ke', 'status'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
