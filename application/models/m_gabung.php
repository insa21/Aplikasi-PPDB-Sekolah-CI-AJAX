...
class m_gabung extends CI_Model
{

    var $table = 'siswa';   //table
    var $column_order = array('photo', 'nama', 'skhun', 'nis', 'jenis_kelamin', 'tahun_masuk', 'ttl', 'alamat', 'agama', 'sekolah_asal', 'nama_ibu', 'nama_ayah', 'email', 'jurusan', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('photo', 'nama', 'skhun', 'nis', 'tahun_masuk', 'ttl', 'sekolah_asal', 'email', 'jurusan'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
