...
class m_galery extends CI_Model
{
    ...
    var $column_order = array('nama', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
