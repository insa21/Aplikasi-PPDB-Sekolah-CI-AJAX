...
class m_gambar extends CI_Model
{
    ...
    var $table = 'gambar';   //table
    var $column_order = array('nama', 'tanggal', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama', 'tanggal'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
