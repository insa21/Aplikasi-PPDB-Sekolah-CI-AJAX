...
class m_isi_profile extends CI_Model
{

    var $table = 'profile_sekolah';   //table
    var $column_order = array('pembuat', 'date', 'tempat', 'nks', 'visi', 'misi', 'tujuan', 'kebijakan', 'moto', 'selengkapnya', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('pembuat', 'date', 'tempat', 'nks'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
