...
class m_jadwal extends CI_Model
{
    ...
    var $table = 'jadwal';   //table
    var $column_order = array('gelombang', 'pendaftaran', 'test', 'kesehatan', 'pengumuman', 'ulang', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('gelombang', 'pendaftaran', 'test', 'kesehatan', 'pengumuman', 'ulang',); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
