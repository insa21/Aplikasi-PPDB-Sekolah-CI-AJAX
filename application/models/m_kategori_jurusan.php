...
class m_kategori_jurusan extends CI_Model
{
    ...
    var $table = 'jurusan';   //table
    var $column_order = array('kategori_jurusan', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('kategori_jurusan'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
