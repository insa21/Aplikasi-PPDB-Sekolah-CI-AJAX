...
class m_komentar extends CI_Model
{
    ...
    var $table = 'komentar';   //table
    var $column_order = array('nama', 'email', 'subjek', 'pesan', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama', 'email', 'subjek'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
