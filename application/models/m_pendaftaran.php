...
class m_pendaftaran extends CI_Model
{
    ...
    var $column_order = array('nama', 'jenis_kelamin', 'tanggal', 'waktu', 'ruangan', 'gelombang', 'testing', 'status', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
