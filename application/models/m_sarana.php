...
class m_sarana extends CI_Model
{
    ...
    var $table = 'sarana';   //table
    var $column_order = array('nama', 'keterangan', 'date', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama', 'keterangan'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
