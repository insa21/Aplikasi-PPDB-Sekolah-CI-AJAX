...
class m_seleksi extends CI_Model
{
    ...
    var $column_order = array('nama', 'jenis_kelamin', 'tanggal', 'waktu', 'ruangan', 'gelombang', 'testing', 'status', 'pesan', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('nama', 'jenis_kelamin', 'tanggal', 'waktu', 'ruangan', 'gelombang', 'testing',); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
