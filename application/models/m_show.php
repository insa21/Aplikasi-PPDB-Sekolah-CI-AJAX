...
class m_show extends CI_Model
{
    ...
    var $column_order = array('title', 'deskripsi', 'date', null); //setel kolom bidang basis data agar dapat didatangkan dengan data
    var $column_search = array('title', 'deskripsi'); //set kolom kolom database untuk dapat dicari datatable hanya nama depan, nama belakang, alamat dapat dicari
