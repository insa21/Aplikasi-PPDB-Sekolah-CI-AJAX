    ...
    <div class="col-md-12 nav-wrapper">
      <div class="navbar-header" style="width:100%;">
        ...
        <ul class="nav navbar-nav navbar-right user-nav">
          <li class="user-name"><span>Indra Saepudin</span></li>
    ...
    <div id="left-menu">
      <div class="sub-left-menu scroll">
        <ul class="nav nav-list">
          ...
          <li class="ripple"><a href="<?php echo base_url() . 'index.php/dashboard' ?>"><span class="fa fa-home"></span>Dashboard</a></li>
          <!-- <span class="fa-angle-right fa right-arrow text-right"></span> -->
          <!-- </a> -->
          <!-- <ul class="nav nav-list tree">
                          <li><a href="<?php echo base_url() . 'index.php/gambar' ?>">Dashboard v.1</a></li>
                          <li><a href="<?php echo base_url() . 'index.php/data_kelas' ?>">Dashboard v.2</a></li>
                      </ul> -->
          </li>
          <li class="ripple">
            <a class="tree-toggle nav-header">
              <span class="fa-diamond fa"></span> Berita
              <span class="fa-angle-right fa right-arrow text-right"></span>
            </a>
            <ul class="nav nav-list tree">
              <li><a href="<?php echo base_url() . 'index.php/artikel/artikel' ?>">Artikel</a></li>
              <li><a href="<?php echo base_url() . 'index.php/artikel_kategori/kategori' ?>">Kategori</a></li>
            </ul>
          </li>
          <li class="ripple"><a href="<?php echo base_url() . 'data_kelas' ?>"><span class="fa fa-folder-open"></span>Data Kelas</a></li>
          <li class="ripple"><a href="<?php echo base_url() . 'gambar' ?>"><span class="fa-area-chart fa"></></span>Upload Gambar</a></li>
          <li class="ripple"><a class="tree-toggle nav-header">
              <span class="fa fa-pencil-square"></span> Komponen <span class="fa-angle-right fa right-arrow text-right"></span> </a>
            <ul class="nav nav-list tree">
              <li><a href="<?php echo base_url() . 'index.php/show' ?>">Jurusan</a></li>
              <li><a href="<?php echo base_url() . 'index.php/sarana' ?>">Sarana dan Prasarana</a></li>
              <!-- <li><a href="<?php echo base_url() . 'index.php/seleksi' ?>">Seleksi</a></li> -->
              <li><a href="<?php echo base_url() . 'index.php/isi_profile' ?>">Profile Sekolah</a></li>
              <li><a href="<?php echo base_url() . 'index.php/kategori_jurusan' ?>">Kategori Jurusan</a></li>
              <li><a href="<?php echo base_url() . 'isi_kepala_sekolah' ?>">Kepala Sekolah</a></li>
              <li><a href="<?php echo base_url() . 'bergerak' ?>">Slide Show</a></li>
            </ul>
          </li>
          <li class="ripple"><a href="<?php echo base_url() . 'index.php/siswa' ?>"><span class="fa fa-users"></span>Calon Siswa</a></li>
          <li class="ripple"><a href="<?php echo base_url() . 'jadwal' ?>"><span class="fa fa-table"></span>Jadwal</a></li>
          <li class="ripple"><a href="<?php echo base_url() . 'seleksi' ?>"><span class="fa fa-user"></span>Seleksi</a></li>
          <li class="ripple"><a href="<?php echo base_url() . 'komentar' ?>"><span class="fa fa-comment"></span>Kometar</a></li>
        </ul>
      </div>
    </div>
    <!-- end: Left Menu -->
        ...
        <div class="panel-body">
          <div class="col-md-6 col-sm-12">
            ...
            <ul class="nav navbar-nav">
              <li><a href="<?php echo base_url() . 'show' ?>">Jurusan</a></li>
              <li><a href="<?php echo base_url() . 'sarana' ?>">Sarana</a></li>
              <li><a href="<?php echo base_url() . 'isi_kepala_sekolah' ?>">Kepala Sekolah</a></li>
              <li><a href="<?php echo base_url() . 'isi_profile' ?>">Profile Sekolah</a></li>
