...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('gabung/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function edit_person(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('gabung/ajax_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('gabung/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('gabung/ajax_update') ?>";
        }
    ...
    function delete_person(id) {
        if (confirm('Apakah anda yakin mau menghapus data ini?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('gabung/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
