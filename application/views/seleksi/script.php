...
<script type="text/javascript">
    ...
    function edit_person(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('seleksi/ajax_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('[name="tahun_masuk"]').datepicker('update', data.tahun_masuk);
                ...
                $('[name="gelombang"]').val(data.gelombang);
                $('[name="testing"]').val(data.testing);
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('seleksi/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('seleksi/ajax_update') ?>";
        }
    ...
    function delete_person(id) {
        if (confirm('Apakah anda yakin mau menghapus data ini?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('seleksi/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
