...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('show/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function edit_person(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('show/ajax_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('show/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('show/ajax_update') ?>";
        }
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Kesalahan menambahkan / memperbarui data');
                $('#btnSave').text('save'); //change button text
                $('#btnSave').attr('disabled', false); //set button enable 
    ...
    function delete_person(id) {
        if (confirm('Apakah anda yakin mau menghapus data ini?')) {
            ...
            $.ajax({
                url: "<?php echo site_url('show/ajax_delete') ?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data) {
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    alert('Kesalahan menghapus data');
                }
            });
