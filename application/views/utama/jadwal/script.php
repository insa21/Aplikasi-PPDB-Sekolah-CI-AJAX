...
<script type="text/javascript">
    ...
    function add_person() {
        ...
        $('.modal-title').text('Tambah Jadwal'); // Setel Judul menjadi judul modal Bootstrap
    ...
    function edit_person(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="pendaftaran"]').val(data.pendaftaran);
                $('[name="test"]').val(data.test);
                $('[name="kesehatan"]').val(data.kesehatan);
                $('[name="pengumuman"]').val(data.pengumuman);
                $('[name="ulang"]').val(data.ulang);
